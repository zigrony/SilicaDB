// Filename: Silica.Concurrency/Diagnostics/ConcurrencyDiagnostics.cs
using System;
...
namespace Silica.Concurrency.Diagnostics
{
    internal static class ConcurrencyDiagnostics
    {
        ...
        internal static void ReloadFromEnvironment()
        {
            ...
            {
                string v = null;
                try { v = Environment.GetEnvironmentVariable("SILICA_CONCURRENCY_VERBOSE"); } catch { }
        ...
        internal static void Emit(string component, string operation, string level, string message, Exception? ex = null, IReadOnlyDictionary<string, string>? more = null)
        {
            ...
            try
            {
                ...
                componentName = string.IsNullOrWhiteSpace(component) ? "Silica.Concurrency" : component;
            ...
            try
            {
                ...
                // Avoid brittle dictionary lookups; pass normalized locals
