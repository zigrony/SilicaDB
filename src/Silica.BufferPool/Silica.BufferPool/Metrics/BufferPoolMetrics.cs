// File: Silica.BufferPool/Metrics/BufferPoolMetrics.cs
using System;
...
namespace Silica.BufferPool.Metrics
{
    /// <summary>
    /// Canonical, low-cardinality BufferPool metric definitions and helpers.
    ...
    public static class BufferPoolMetrics
    {
        ...
        public static void IncrementEviction(IMetricsManager metrics, string? reasonField = null, string? policy = null)
        {
            if (metrics is null) return;
